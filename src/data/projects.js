...
// Данные для длинных статей
export const longsData = {
    'drive-my-car': {
        id: 'drive-my-car',
        title: 'Обзор: Сядь за руль моей машины',
        description: 'Обзор японского фильма, получившего "Оскар"',
        markdownPath: './data/longs/long_1.md',
        date: '2024-03'
    }
    // Здесь можно добавлять другие статьи
};
